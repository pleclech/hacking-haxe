...
MODULES=ast type lexer vfs common genxml parser typecore optimizer typeload \
...
common.$(MODULE_EXT): vfs.$(MODULE_EXT) type.$(MODULE_EXT) ast.$(MODULE_EXT) libs/ilib/il.$(LIB_EXT)
...
typeload.$(MODULE_EXT): vfs.$(MODULE_EXT) typecore.$(MODULE_EXT) type.$(MODULE_EXT) parser.$(MODULE_EXT) optimizer.$(MODULE_EXT) lexer.$(MODULE_EXT) common.$(MODULE_EXT) ast.$(MODULE_EXT)
