...
src/generators/codegen.$(MODULE_EXT): src/globals.$(MODULE_EXT) src/typing/type.$(MODULE_EXT) src/generators/genxml.$(MODULE_EXT) src/context/common.$(MODULE_EXT) src/syntax/ast.$(MODULE_EXT) src/typing/abstract.$(MODULE_EXT)
...
src/extended/refs.$(MODULE_EXT): src/syntax/ast.$(MODULE_EXT) src/globals.$(MODULE_EXT) src/typing/type.$(MODULE_EXT) src/extended/refs.ml
...
# typing
src/extended/exttyper.$(MODULE_EXT): src/context/meta.$(MODULE_EXT) src/typing/type.$(MODULE_EXT) src/typing/error.$(MODULE_EXT) src/globals.$(MODULE_EXT) src/extended/refs.$(MODULE_EXT) src/syntax/parser.$(MODULE_EXT) src/syntax/ast.$(MODULE_EXT)
...
src/typing/overloads.$(MODULE_EXT): src/typing/abstract.$(MODULE_EXT) src/context/meta.$(MODULE_EXT) src/typing/type.$(MODULE_EXT) src/typing/abstract.$(MODULE_EXT)
